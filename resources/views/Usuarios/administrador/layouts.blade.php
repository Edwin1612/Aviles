                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    <a href="/Administradores">
                                        <span class="pcoded-micon"><i class="icofont icofont-home"></i><b>P</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.page_layout.main">Inicio</span>
                                    </a>
                                    <a href="/Administrador/Temas">
                                        <span class="pcoded-micon"><i class="icofont icofont-listing-number"></i><b>P</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.page_layout.main">Temas</span>
                                    </a>
                                    <a href="/Administrador/Ejercicios">
                                        <span class="pcoded-micon"><i class="icofont icofont-pencil-alt-5"></i><b>P</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.page_layout.main">Ejecricios</span>
                                    </a>
                                    <a href="/Administrador/Usuarios">
                                        <span class="pcoded-micon"><i class="icofont icofont-users"></i><b>P</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.page_layout.main">Usuarios</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
